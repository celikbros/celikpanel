...
sh /tmp/celikpanel-get.sh --version v0.1.0-alpha.66
```
...
```bash
make dist-sign VERSION=v0.1.0-alpha.66 SIGNING_KEY=<tam-anahtar-parmak-izi>
gpg --verify dist/celikpanel-v0.1.0-alpha.66.tar.gz.asc dist/celikpanel-v0.1.0-alpha.66.tar.gz
```
