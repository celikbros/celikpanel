...
grep -Fxq 'bootstrap_release_sequence=48' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha48 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.48' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha48 release version"
