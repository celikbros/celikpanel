...
grep -Fxq 'bootstrap_release_sequence=49' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha49 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.49' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha49 release version"
