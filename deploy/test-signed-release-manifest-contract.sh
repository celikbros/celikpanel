...
grep -Fxq 'bootstrap_release_sequence=47' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha47 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.47' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha47 release version"
