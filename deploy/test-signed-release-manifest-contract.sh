...
grep -Fxq 'bootstrap_release_sequence=46' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha45 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.46' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha45 release version"
