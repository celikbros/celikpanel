...
grep -Fxq 'bootstrap_release_sequence=50' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha50 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.50' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha50 release version"
