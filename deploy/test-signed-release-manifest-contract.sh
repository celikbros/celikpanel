...
grep -Fxq 'bootstrap_release_sequence=43' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha43 release sequence"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.43' "$bootstrap" \
  || fail "bootstrap does not pin the Alpha43 release version"
