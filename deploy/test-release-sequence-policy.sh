...
[[ "$policy_version" == v0.1.0-alpha.56 ]] || die 'tracked version must be v0.1.0-alpha.56'
[[ "$policy_current" == 56 ]] || die 'tracked current sequence must be 56'
[[ "$policy_previous" == 55 ]] || die 'tracked previous sequence must be 55'
[[ "$policy_previous_version" == v0.1.0-alpha.55 ]] || die 'tracked previous version must be v0.1.0-alpha.55'
[[ "$policy_previous_commit" == 9de8e4775c0e9ca134ba9bbef11fa6a6e6050132 ]] \
  || die 'tracked previous commit must be the immutable Alpha55 release commit'
