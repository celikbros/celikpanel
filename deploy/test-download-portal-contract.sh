...
grep -Fxq 'bootstrap_release_sequence=72' "$bootstrap" || fail "bootstrap sequence pin is missing"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.72' "$bootstrap" || fail "bootstrap version pin is missing"
