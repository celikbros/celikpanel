...
grep -Fxq 'bootstrap_release_sequence=45' "$bootstrap" || fail "bootstrap sequence pin is missing"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.45' "$bootstrap" || fail "bootstrap version pin is missing"
