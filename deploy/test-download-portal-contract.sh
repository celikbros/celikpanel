...
grep -Fxq 'bootstrap_release_sequence=75' "$bootstrap" || fail "bootstrap sequence pin is missing"
grep -Fxq 'bootstrap_release_version=v0.1.0-alpha.75' "$bootstrap" || fail "bootstrap version pin is missing"
