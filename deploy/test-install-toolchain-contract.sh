...
require_literal 'chown -R root:root -- "$installed_web_root"'
require_literal 'find "$installed_web_root" -xdev -type d -exec chmod 0755 -- {} +'
require_literal 'find "$installed_web_root" -xdev -type f -exec chmod 0644 -- {} +'
require_literal 'find "$installed_web_root" -xdev -type d ! -perm 0755 -print -quit'
require_literal 'find "$installed_web_root" -xdev -type f ! -perm 0644 -print -quit'
require_before 'cp -a "$SRC/web/dist/." "$installed_web_root/"' 'chown -R root:root -- "$installed_web_root"'
require_before 'chown -R root:root -- "$installed_web_root"' '[[ -f "$installed_web_root/index.html"'
