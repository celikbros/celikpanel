...
require_literal 'step "Small prerequisites (curl, tar, xz, nftables)" \'
require_literal '"Küçük ön gereksinimler (curl, tar, xz, nftables)"'
...
reject_literal 'step "Küçük ön gereksinimler (curl, tar, xz, nftables)"'
