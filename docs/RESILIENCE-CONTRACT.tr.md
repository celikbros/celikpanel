...
| P0.5 | Kısmi — bağımsız paket firewall ve Debian güncelleme/geri alma; yenileme ve geniş matris açık | [Yönetim yokken boot](../deploy/e2e/release-recovery/FIREWALL-BOOT.md), [korunan A/B/A nesilleri](../deploy/e2e/release-recovery/FIREWALL-GENERATIONS.md) ve [gerçek Debian imzalı worker güncellemesi/otomatik geri alma](../deploy/e2e/release-recovery/FIREWALL-UPDATE.md) için sınırlı kanıt var. Paket birimi bağımsız korunan yardımcıyı kullanır; eski/doğrudan kaynak birimleri sessizce değiştirilmez. Üretim arayüzü/imzası, Arch, bozuk yardımcı boot/konsol kurtarması, bağımsız yenileme ve iddia edilen her yerel hizmet/yönetim-yokluğu birleşimi açık. |
