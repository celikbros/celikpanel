...
| P0.3 | Kısmi — sürümlü yürütücü, snapshot kimliğine bağlı aşamalar ve atomik program yayını uygulandı | [Bağımsız kurtarma ortamı](RECOVERY-RUNTIME.tr.md), gerçek süreç öldürme/WAL testleri ve [unit geçiş kabulü](../deploy/e2e/release-recovery/UNIT-TRANSITION.tr.md). Tam aşama/reboot kanıtı, korunan veriden bağımsızlık, metadata geçişleri ve temizleme açıktır. |
