...
| P0.3 | Açık güncelleme kontrol noktalarıyla kararlı kurtarma manifesti/yürütücüsü. | Her kontrol noktasında ve geri alma sırasında hata oluştur; kurtarma sürecini sonlandır veya sunucuyu yeniden başlat; geliştiriciye özel betik olmadan desteklenen bir nihai duruma ulaşılabildiğini ve kurtarma erişiminin sürdüğünü doğrula. Etkinleştirmeden önce eski snapshot uyumluluğunu kanıtla. |
