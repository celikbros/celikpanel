...
export function DomainLogsViewer({ domainId, domainName }: DomainLogsViewerProps) {
    ...
    const getLogTypeColor = (type: string) => {
        switch (type) {
            ...
            case 'php': return 'text-yellow-400';
    ...
    return (
        <div className="space-y-6">
            <div>
                <h3 className="text-lg font-bold text-gray-100 mb-2">Log Viewer</h3>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    {/* Lines Selector */}
                    <div>
                        <label className="block text-sm text-gray-400 mb-2">Lines to Show</label>
                        <select
                            value={lines}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-gray-900 border border-gray-700 rounded px-4 py-2 pr-10 text-white focus:border-blue-500 focus:outline-none"
                            />
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={loadLogs}
                                disabled={loading}
                                className="flex-1 px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-1"
                                title="Refresh"
                            >
                ...
                <div className="mt-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-sm text-white">Auto-refresh every 5 seconds</span>
                    </label>
                </div>
            </div>
                        ...
                        <div className="bg-gray-950 rounded p-4 overflow-x-auto">
                            <pre className="text-xs text-gray-300 font-mono whitespace-pre-wrap">
                                {logs.map((line, index) => (
                                    <div
                                        key={index}
                                        className="hover:bg-gray-800/50 px-2 py-0.5 rounded"
                                    >
