...
const englishText = new Map([
  ...
  ["Neler yapabilir", "See what it does"],
  ...
  ["Panellerin çoğu aynı özellik listesini sayar. Fark, bir şey ters gittiğinde ortaya çıkar. CelikPanel'i ayıran sekiz nokta:", "Most panels list the same features. The difference shows when something goes wrong. Eight places where CelikPanel is not the same:"],
  ...
  ["Panel kök parolayı kendi eline alır; artık sizin değildir.", "The panel takes the root password into its own hands; it is no longer yours."],
  ...
  ["Sağ sütundaki her sayı gerçek bir makinede ölçüldü ve aşağıdaki kanıt defterinde tarihiyle duruyor.", "Every number in the right-hand column was measured on a real machine and stands, with its date, in the ledger below."],
  ["aşağıdaki kanıt defterinde", "in the ledger below"],
