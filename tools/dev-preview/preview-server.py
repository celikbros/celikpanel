...
API = {
    ...
    '/api/v1/domains': [
        ...
        {'id': 4, 'domain_name': 'biovision.health', 'php_version': '', 'ssl_enabled': True,
         'status': 'active', 'project_type': 'static', 'created_at': now, 'disk_usage': 551, 'bandwidth': 19_456},
    ],
    '/api/v1/domains/4/usage': {'disk_usage': 551, 'bandwidth': 19_456},
    '/api/v1/domains/4/connection': {
        'domain': 'biovision.health',
        'server_ip': '2.25.80.4',
        'server_ipv6': '2a02:4780:75:efdb::1',
        'nameservers': ['ns1.celikhost.com', 'ns2.celikhost.com'],
        'live_nameservers': ['ns1.celikhost.com', 'ns2.celikhost.com'],
        'live_ips': ['2.25.80.4', '2a02:4780:75:efdb::1'],
        'status': 'delegated',
        'ssl_ready': True,
        'propagation_pending': False,
        'glue_needed': False,
        'nameservers_usable': True,
        'checked_at': now,
    },
    '/api/v1/domains/4/ssl': {
        'domain_id': 4,
        'domain_name': 'biovision.health',
        ...
        'certificate': {
            ...
            'subject': 'biovision.health',
            'issued_at': '2026-07-26T12:45:00Z',
            'expires_at': '2026-10-24T12:45:00Z',
            'days_until_expiry': 89,
            'auto_renew': True,
            'renewal_status': 'scheduled',
            'status': 'valid',
            'dns_names': ['biovision.health', 'www.biovision.health', 'mail.biovision.health'],
            'activated': True,
            'usable': True,
            'trust_status': 'trusted',
            'activation_pending': False,
            'dependents_pending': False,
        },
        'settings': {
            'force_https': True,
            'hsts_enabled': True,
            'hsts_max_age': 31536000,
            'hsts_retire_after': None,
        },
        'managed_names': ['biovision.health', 'www.biovision.health'],
    },
    '/api/v1/domains/4/ssl/mail': {'secure_mail': True},
    '/api/v1/ssl/providers': {'providers': [
        {
            'id': 'letsencrypt',
            'name': "Let's Encrypt",
            'note': 'Free, 90-day certificates with automatic renewal.',
            'needs_eab': False,
        },
        {
            'id': 'zerossl',
            'name': 'ZeroSSL',
            'note': 'ACME certificates using External Account Binding.',
            'needs_eab': True,
        },
    ]},
